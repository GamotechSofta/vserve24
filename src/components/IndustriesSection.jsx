...
const INDUSTRY_CONFIG = {
  'ind-1': { image: imgDigital, icon: Film, color: '#FF5500', bg: 'bg-orange-50', border: 'border-orange-200', mcc: 'MCC 5967', cap: '$3.5M/mo', speed: '24h Approval', reserve: '0% - 5%' },
  'ind-2': { image: imgAcquirer, icon: Scale, color: '#0B192C', bg: 'bg-slate-100', border: 'border-slate-300', mcc: 'MCC 7322', cap: '$2.0M/mo', speed: '48h Approval', reserve: '0% Rolling' },
  'ind-3': { image: imgCbd, icon: Leaf, color: '#10B981', bg: 'bg-emerald-50', border: 'border-emerald-200', mcc: 'MCC 5993', cap: '$1.5M/mo', speed: '24h Approval', reserve: '0% Rolling' },
  'ind-4': { image: imgRetail, icon: Package, color: '#FF5500', bg: 'bg-orange-50', border: 'border-orange-200', mcc: 'MCC 5969', cap: '$2.5M/mo', speed: '24h Approval', reserve: '0% - 3%' },
  'ind-5': { image: imgRetail, icon: Wind, color: '#6366F1', bg: 'bg-indigo-50', border: 'border-indigo-200', mcc: 'MCC 5993', cap: '$1.2M/mo', speed: '48h Approval', reserve: '0% - 5%' },
  'ind-6': { image: imgShield, icon: Award, color: '#0B192C', bg: 'bg-slate-100', border: 'border-slate-300', mcc: 'MCC 5968', cap: '$5.0M/mo', speed: '24h Approval', reserve: '0% Rolling' },
  'ind-7': { image: imgShield, icon: Target, color: '#0B192C', bg: 'bg-slate-100', border: 'border-slate-300', mcc: 'MCC 5941', cap: '$1.0M/mo', speed: '48h Approval', reserve: '0% Rolling' },
  'ind-8': { image: imgDigital, icon: Trophy, color: '#F59E0B', bg: 'bg-amber-50', border: 'border-amber-200', mcc: 'MCC 7999', cap: '$3.0M/mo', speed: '24h Approval', reserve: '0% Rolling' },
  'ind-9': { image: imgAcquirer, icon: GraduationCap, color: '#FF5500', bg: 'bg-orange-50', border: 'border-orange-200', mcc: 'MCC 8299', cap: '$2.0M/mo', speed: '24h Approval', reserve: '0% Rolling' },
  'ind-10': { image: imgJewelry, icon: Gem, color: '#06B6D4', bg: 'bg-cyan-50', border: 'border-cyan-200', mcc: 'MCC 5944', cap: '$4.0M/mo', speed: '24h Approval', reserve: '0% Rolling' },
  'ind-11': { image: imgTravel, icon: Landmark, color: '#0B192C', bg: 'bg-slate-100', border: 'border-slate-300', mcc: 'MCC 5045', cap: '$10.0M/mo', speed: '24h Approval', reserve: '0% Rolling' },
  'ind-12': { image: imgTravel, icon: BadgeDollarSign, color: '#10B981', bg: 'bg-emerald-50', border: 'border-emerald-200', mcc: 'MCC 6012', cap: '$3.0M/mo', speed: '48h Approval', reserve: '0% - 5%' },
  'ind-13': { image: imgTravel, icon: Truck, color: '#FF5500', bg: 'bg-orange-50', border: 'border-orange-200', mcc: 'MCC 4214', cap: '$2.5M/mo', speed: '24h Approval', reserve: '0% Rolling' },
  'ind-14': { image: imgMultichannel, icon: Users, color: '#8B5CF6', bg: 'bg-purple-50', border: 'border-purple-200', mcc: 'MCC 5960', cap: '$4.5M/mo', speed: '48h Approval', reserve: '0% - 5%' },
  'ind-15': { image: imgHealth, icon: Pill, color: '#10B981', bg: 'bg-emerald-50', border: 'border-emerald-200', mcc: 'MCC 5912', cap: '$5.0M/mo', speed: '24h Approval', reserve: '0% Rolling' },
  'ind-16': { image: imgDigital, icon: Heart, color: '#EC4899', bg: 'bg-pink-50', border: 'border-pink-200', mcc: 'MCC 7273', cap: '$3.0M/mo', speed: '24h Approval', reserve: '0% Rolling' },
  'ind-17': { image: imgRetail, icon: Home, color: '#854D0E', bg: 'bg-yellow-50', border: 'border-yellow-200', mcc: 'MCC 5712', cap: '$2.0M/mo', speed: '24h Approval', reserve: '0% Rolling' },
  'ind-18': { image: imgDigital, icon: Moon, color: '#8B5CF6', bg: 'bg-purple-50', border: 'border-purple-200', mcc: 'MCC 7299', cap: '$1.5M/mo', speed: '24h Approval', reserve: '0% Rolling' },
  'ind-19': { image: imgSubscription, icon: RotateCw, color: '#FF5500', bg: 'bg-orange-50', border: 'border-orange-200', mcc: 'MCC 5734', cap: '$6.0M/mo', speed: '24h Approval', reserve: '0% Rolling' },
  'ind-20': { image: imgDigital, icon: TrendingUp, color: '#10B981', bg: 'bg-emerald-50', border: 'border-emerald-200', mcc: 'MCC 7311', cap: '$2.0M/mo', speed: '24h Approval', reserve: '0% Rolling' },
  'ind-21': { image: imgDigital, icon: Code, color: '#3B82F6', bg: 'bg-blue-50', border: 'border-blue-200', mcc: 'MCC 5817', cap: '$4.0M/mo', speed: '24h Approval', reserve: '0% Rolling' },
  'ind-22': { image: imgHealth, icon: HeartPulse, color: '#EF4444', bg: 'bg-red-50', border: 'border-red-200', mcc: 'MCC 8099', cap: '$3.5M/mo', speed: '24h Approval', reserve: '0% Rolling' },
  'ind-23': { image: imgTravel, icon: Plane, color: '#0284C7', bg: 'bg-sky-50', border: 'border-sky-200', mcc: 'MCC 4722', cap: '$5.0M/mo', speed: '24h Approval', reserve: '0% - 5%' },
  'ind-24': { image: imgDigital, icon: Server, color: '#0B192C', bg: 'bg-slate-100', border: 'border-slate-300', mcc: 'MCC 7374', cap: '$3.0M/mo', speed: '24h Approval', reserve: '0% Rolling' },
};
        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-10">
          ...
          <div className="flex items-center gap-1.5 p-1.5 rounded-2xl bg-[#FFFFFF] border border-[#E7E3DA] shadow-xs overflow-x-auto scrollbar-none w-full sm:w-auto self-start lg:self-auto">
            <button
              ...
              className={`flex items-center gap-1.5 px-3 py-1.5 sm:px-3.5 sm:py-2 rounded-xl text-xs font-mono font-bold whitespace-nowrap transition-all cursor-pointer ${
                viewMode === 'circular'
        ...
        <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3 mb-8 pb-5 border-b border-[#E7E3DA]">
          <div className="flex items-center gap-1.5 overflow-x-auto pb-1 md:pb-0 scrollbar-none">
            {categories.map((cat) => (
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-xs font-mono font-semibold tracking-wider uppercase whitespace-nowrap transition-all cursor-pointer flex items-center gap-1.5 ${
          ...
          <div className="relative min-w-[240px]">
            ...
            <input
              ...
              className="w-full pl-9 pr-3.5 py-2 rounded-xl bg-[#FFFFFF] border border-[#E7E3DA] text-xs font-mono text-[#0B192C] placeholder-slate-400 focus:outline-none focus:border-[#FF5500] transition-colors shadow-xs"
            />
            {searchQuery && (
        ...
        {viewMode === 'circular' && (
          <div className="bg-[#FFFFFF] border border-[#E7E3DA] rounded-3xl p-6 sm:p-8 lg:p-12 shadow-sm relative overflow-hidden">
            ...
            <div className="flex items-center justify-between mb-8 pb-4 border-b border-[#E7E3DA]">
              <div className="flex items-center gap-2 text-xs font-mono text-[#707887]">
              ...
              <button
                ...
                className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl border border-[#E7E3DA] bg-[#F7F4ED] hover:bg-[#FFFFFF] text-xs font-mono font-bold text-[#0B192C] transition-colors cursor-pointer shadow-xs"
              >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center min-h-[580px]">
              ...
              <div className="lg:col-span-5 space-y-5 bg-[#F7F4ED] border border-[#E7E3DA] p-6 sm:p-7 rounded-3xl relative shadow-md">
                ...
                <div className="relative aspect-[16/9] rounded-2xl overflow-hidden border border-[#E7E3DA] shadow-md bg-white">
                  ...
                  <div className="absolute top-3 left-3 bg-[#0B192C]/90 backdrop-blur-md text-white text-[10px] font-mono font-bold px-2.5 py-1 rounded-lg uppercase tracking-wider shadow-sm">
                    {activeIndustry.category}
                  </div>

                  <div className="absolute top-3 right-3 bg-white/95 backdrop-blur-md border border-[#E7E3DA] text-[#FF5500] text-[10px] font-mono font-bold px-2.5 py-1 rounded-lg shadow-sm">
                    {activeConfig.mcc}
                  </div>
                ...
                {/* Title & Desc */}
                <div>
                  <div className="inline-flex items-center gap-1.5 text-[10px] font-mono font-bold uppercase tracking-widest text-[#FF5500] bg-orange-50 border border-orange-200/80 px-2.5 py-0.5 rounded">
                ...
                <div className="grid grid-cols-3 gap-2 pt-2 border-t border-[#E7E3DA] text-xs font-mono">
                ...
                <div className="pt-2 flex items-center gap-3">
                  <button
                    ...
                    className="flex-1 py-3 px-4 rounded-xl bg-[#0B192C] hover:bg-[#1A283E] text-white text-xs font-mono font-bold tracking-wide transition-all text-center cursor-pointer shadow-sm"
                  >
                    View Underwriting Sheet
                  </button>
                  <button
                    onClick={onOpenApplication}
                    className="py-3 px-5 rounded-xl bg-[#FF5500] hover:bg-[#E64A00] text-white text-xs font-mono font-bold tracking-wide transition-all flex items-center gap-1.5 cursor-pointer shadow-md shadow-orange-500/20 hover:-translate-y-0.5"
                  >
                    <span>Apply</span>
              ...
              >
                ...
                <div className="relative z-20 w-32 h-32 rounded-full bg-gradient-to-br from-[#0B192C] to-[#1A283E] border-4 border-white shadow-2xl flex flex-col items-center justify-center text-white text-center p-3">
                  ...
                  <span className="text-[12px] font-mono font-bold tracking-wider text-[#FF5500]">VSERVE24</span>
                  <span className="text-[9px] font-mono text-slate-300">BANKING HUB</span>
                  <span className="text-[8px] font-mono text-[#10B981] mt-0.5">● 24 MIDs ONLINE</span>
                </div>
                  ...
                  return (
                    ...
                    >
                      <div className={`p-2.5 rounded-2xl border transition-all duration-300 flex items-center gap-2 shadow-md ${
                        ...
                        <span className="text-[10px] font-mono font-bold whitespace-nowrap pr-1">
                          {ind.name}
                        </span>
                      </div>
                    </div>
            ...
            {filteredIndustries.map((ind) => {
              ...
              return (
                ...
                >
                  ...
                  <div>
                    <div className="text-[9px] font-mono text-[#FF5500] uppercase font-bold tracking-widest mt-2">
                      {ind.category}
                    </div>
                  ...
                  <div className="text-[9.5px] font-mono text-[#10B981] font-bold mt-1 flex items-center gap-1">
              ...
              return (
                ...
                >
                  ...
                  <div className="relative aspect-[16/9] overflow-hidden bg-slate-100 border-b border-[#E7E3DA]">
                    ...
                    <div className="absolute top-2.5 left-2.5 bg-[#0B192C]/85 backdrop-blur-md text-white text-[9.5px] font-mono font-bold px-2 py-0.5 rounded-md uppercase tracking-wider shadow-sm">
                      {ind.category}
                    </div>

                    <div className="absolute top-2.5 right-2.5 bg-white/90 backdrop-blur-md text-[#FF5500] text-[9.5px] font-mono font-bold px-2 py-0.5 rounded-md shadow-xs">
                      {config.mcc}
                    </div>
                  ...
                  <div className="p-4 sm:p-5 flex-1 flex flex-col justify-between space-y-2">
                    ...
                    <div className="pt-3 border-t border-[#E7E3DA] flex items-center justify-between text-[11px] font-mono text-[#707887] group-hover:text-[#0B192C] transition-colors">
          ...
          >
            ...
            <div className="relative aspect-[21/9] overflow-hidden bg-slate-100 border-b border-[#E7E3DA]">
              ...
              <div className="absolute bottom-3 left-4 right-4 text-white">
                <div className="text-[10px] font-mono font-bold uppercase tracking-widest text-[#FF5500] bg-black/40 backdrop-blur-md px-2 py-0.5 rounded inline-block mb-1">
            ...
            <div className="p-6 sm:p-7 space-y-5">
              ...
              <div className="space-y-2 pt-2 border-t border-[#E7E3DA] text-xs font-mono">
              ...
              <div className="pt-2 flex items-center justify-end gap-3">
                <button
                  onClick={() => setActiveModalIndustry(null)}
                  className="px-4 py-2.5 rounded-xl border border-[#E7E3DA] text-xs font-mono text-[#475569] hover:text-[#0B192C] hover:bg-[#F7F4ED] transition-colors cursor-pointer"
                >
                  Close
                </button>
                <button
                  onClick={() => { setActiveModalIndustry(null); onOpenApplication?.(); }}
                  className="flex items-center gap-2 px-5 py-2.5 rounded-xl bg-[#FF5500] hover:bg-[#E64A00] text-white text-xs font-mono font-bold tracking-wide transition-all shadow-md shadow-orange-500/20 hover:-translate-y-0.5 cursor-pointer"
                >
